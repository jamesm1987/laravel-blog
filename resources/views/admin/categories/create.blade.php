        ...
        <div class="md:w-2/3 lg:w-3/4 px-5">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form class="pt-6 pb-8 mb-4" action="{{ route('admin.categories.store') }}" method="POST">
                        @csrf
                        <div class="my-4">
                        ...
                        <button type="submit" class="px-4 py-2 bg-blue-800 text-white" href="#">Add New Category</button>
                    </form>
                </div>
            </div>
        </div>
